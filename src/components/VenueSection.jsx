    ...
    return (
        ...
        >
            ...
            <div className="max-w-[420px] mx-auto relative z-[3]">
                ...
                >
                    <p className="font-body text-[9px] tracking-[4px] uppercase text-gold-dark mb-2">Join Us At</p>
                    <h2 className="font-script text-[54px] text-brown leading-[1.1] mb-2.5">The Venue</h2>
                ...
                >
                    ...
                    >
                        ...
                        <p
                            className="font-script text-[34px] text-[#ffd700]"
                            style={{ textShadow: '0 2px 12px rgba(0,0,0,0.3)' }}
                        >
                            Aditya Lawn
                        </p>
                        <p className="font-body text-[11px] tracking-[2px] text-white/70 uppercase mt-1">
                            Jalgaon, Maharashtra
                        </p>
                    </div>
                    ...
                    <div className="p-6">
                        ...
                        >
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.5!2d75.562!3d20.993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd90e6a4780e889%3A0xb52befc42ade5c8a!2sJalgaon%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
                                width="100%"
                                height="195"
                        ...
                        <motion.a
                            href="https://maps.google.com/?q=Jalgaon+Maharashtra"
                            target="_blank"
